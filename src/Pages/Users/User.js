...
import{getUserAndRepos} from '../../Context/Action/GithubAction'
                ...
                <div className="w-full mx-auto lg:w-10/12">
                    ...
                    <div className="mb-4">
                        <Link to='/' className='btn btn-ghost'>
                            <p className="lead">Back To Search</p>
                        </Link>
                    </div>
                    {/* /////////////////////////////////////// */}
                                ...
                                {blog && (
                                    <div className="stat">
                                        ...
                                        <div className="text-lg stat-value">
                                            <a href={`http://${blog}`} target="-blank" rel="noreferrer">{blog}</a>
                                        </div>
                                    </div>
                                )}
                                {twitter_username && (
                                    <div className="stat">
                                        ...
                                        <div className="text-lg stat-value">
                                            <a href={`http://twitter.com/${twitter_username}`} target="-blank" rel="noreferrer">{twitter_username}</a>
                                        </div>
                                    </div>
                                )}
                            </div>
